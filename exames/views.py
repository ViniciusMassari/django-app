...
from .models import AcessoMedico, PedidosExames, TiposExames, SolicitacaoExame
...
def fechar_pedido(request):
    ...
    for exame in solicitacao_exames:
        # lógica de marcar data que o paciente deve comparecer
...
def permitir_abrir_exame(request, exame_id):
    ...
    if not exame.id == exame_id:
        if not exame.requer_senha and exame.resultado:
